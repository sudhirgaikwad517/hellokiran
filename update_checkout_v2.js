...
const srcFile = 'd:/hellokiran/sumit_checkout_ref.html';
...
html = html.replace("What You Get On This Call", "What You Get On This D2C Growth Strategy Session");
html = html.replace("What Happens After You Pay", "What Happens After You Book Your ₹99 D2C Growth Strategy Session");

// Replace What Happens After You Pay
html = html.replace("Pay the ₹99 refundable deposit below — takes 30 seconds", "Pay the ₹99 refundable booking amount below — it takes less than 30 seconds. This confirms your slot and ensures we work only with serious D2C brand owners.");
...
html = html.replace("Fill a short 2-minute application so Sumit comes fully prepared for your call", "Fill out a short 2-minute application with details about your: Brand & Product, Current Monthly Revenue, Meta Ads Performance, Biggest Growth Challenges.");
...
html = html.replace("Show up, get your custom roadmap, and ₹99 is refunded instantly — zero risk", "Join your personalized 1:1 D2C Growth Strategy Session and discover: Your Biggest Revenue Leaks, Meta Ads & Creative Analysis, W.A.R.P.™ Growth Roadmap, 30-Day Scaling Action Plan. Your ₹99 booking amount will be refunded when we connect. Zero Risk. No Pressure. No Hard Selling. Just a clear roadmap to scale your D2C brand. 🚀");
...
html = html.replace('<div class="cred-stat-label-c9e">Agencies Helped</div>', '<div class="cred-stat-label-c9e">Businesses Served Across Multiple Industries</div>');
...
html = html.replace('so Sumit comes to the call fully prepared', 'so Kiran comes to the call fully prepared');
...
html = html.replace('If GrowthX Club is a fit, Sumit will mention it. If it\'s not, he\'ll tell you that too. Zero pressure, always.', 'If we believe we can help you scale, we\'ll explain the next steps. If we\'re not the right fit, we\'ll tell you honestly. No pressure. No forced selling.');
html = html.replace("Sumit takes a <strong>maximum of 5 growth calls per week</strong> — and they fill up fast.", "I personally take a limited number of D2C Growth Strategy Sessions every week to ensure every brand gets a proper analysis and actionable roadmap.");
html = html.replace("The people who booked this call last week? They're already implementing their custom roadmaps while their competitors are still \"thinking about it.\" <strong>Every week you delay is another week of leaving ₹3–8 lakhs on the table.</strong>", "The brands that take action today are already identifying their growth leaks, improving their marketing systems, and building a clear scaling roadmap. The only risk of waiting is staying stuck with the same problems — inconsistent sales, wasted ad spend, and unclear growth direction.");


// Upsell HTML based on reference layout styles but with HTML content
const upsellHTML = `
...
<div class="upsell-card-v3a fade-in-up-anim-q4j visible-state-r7h">
    ...
    <p class="upsell-subhead-k8d">90%+ D2C Brand Owners Choose This Growth Blueprint.</p>
    ...
    <p class="upsell-subhead-k8d" style="color: #FBBF24; font-weight:bold; margin-top:10px;">⚡ Limited-Time Offer: Get This Exclusive D2C Growth Blueprint For Just <s>₹499</s> ₹199</p>
    <p class="upsell-subhead-k8d">ONLY Available After Your Strategy Session! 🚀</p>
    <p class="upsell-subhead-k8d">This offer is available only for serious D2C brand owners who want to build a predictable growth system.</p>
...
<div class="upsell-card-v3a fade-in-up-anim-q4j visible-state-r7h" style="margin-top: 20px;">
    ...
    <p class="upsell-subhead-k8d">Create Offers That Increase Conversions & Drive More Sales. 77%+ D2C Brand Owners Use This Framework To Improve Their Offers.</p>
    <p class="upsell-subhead-k8d">A plug-and-play offer creation system designed to help you create irresistible offers that make customers choose your brand over competitors.</p>
    <p class="upsell-subhead-k8d" style="color: #FBBF24; font-weight:bold;">Here's What You'll Get:</p>
    <ul class="upsell-list-f4r">
    ...
    <p class="upsell-subhead-k8d" style="color: #FBBF24; font-weight:bold; margin-top:10px;">⚡ Stop Losing Customers Because Your Offer Isn't Clear</p>
    <p class="upsell-subhead-k8d" style="margin-bottom: 5px;">Create offers that improve:</p>
    <ul class="upsell-list-f4r" style="margin-bottom: 15px;">
    ...
    <p class="upsell-subhead-k8d" style="color: #FBBF24; font-weight:bold;">🔥 Limited-Time Offer: Get This D2C Offer Creation Blueprint For Just <s>₹1499</s> ₹399 Only!</p>
    <p class="upsell-subhead-k8d">(Grab it now before this exclusive offer disappears!)</p>
    <div class="upsell-price-g7m">
